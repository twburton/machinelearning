...
class Kmeans(object):
    ...
    def __init__(self, k=5, max_iterations=5, min_distance=.1, size=800):
        self.k = k
    ...
    def showCentroidColours(self):
        ...
        for cluster in self.clusters:
            ...
            listclustercentroid=list(cluster.centroid)
            count=0
            for i in listclustercentroid:
                listclustercentroid[count]=int(i)
                count += 1
            print("cluster.centroid")
            print(cluster.centroid)
            tupleclustercentroid=tuple(listclustercentroid)
            image = Image.new("RGB", (2000, 2000), tupleclustercentroid)
            image.show()
